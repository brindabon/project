...
def rstore():
    os.system("py captureface_database1.py")

def istore():
    os.system("py gray.py")
...
root.button = Button(root.frame, text="FACE STORE USING CAM", font='Courier 15 bold', bg="red", command=rstore)
root.button.place(x=82, y=y + 200)

root.button = Button(root.frame, text="FACE STORE USING IMAGE", font='Courier 15 bold', bg="red", command=istore)
