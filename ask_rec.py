...
def rstore():
    os.system("py database_detector1.py")

def istore():
    os.system("py img_rec.py")
...
root.button = Button(root.frame, text="RECOGNITION FACE USING CAM", font='Courier 15 bold', bg="red", command=rstore)
root.button.place(x=65, y=y + 200)

root.button = Button(root.frame, text="RECOGNITION FACE USING IMAGE", font='Courier 15 bold', bg="red", command=istore)
root.button.place(x=55, y=y + 270)
